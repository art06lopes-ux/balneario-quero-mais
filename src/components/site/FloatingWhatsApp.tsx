...
export function FloatingWhatsApp({ number }: { number: string }) {
  ...
  return (
    <motion.a
      ...
      className="group fixed right-5 bottom-5 z-[60] grid size-[60px] place-items-center rounded-full bg-wa text-white shadow-wa transition-[bottom] duration-300 max-md:size-[54px] max-md:[[data-mobile-cta]_&]:bottom-[88px]"
    >
