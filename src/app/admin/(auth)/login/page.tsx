...
export default async function LoginPage({ searchParams }: { searchParams: Promise<{ redirecionar?: string }> }) {
  const { redirecionar } = await searchParams;
  return (
    <>
      <h1 className="mb-1 font-display text-2xl font-extrabold text-forest-800">Entrar no painel</h1>
